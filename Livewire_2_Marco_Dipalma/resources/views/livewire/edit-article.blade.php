        ...
        <div class="container-fluid mt-5">
            <div class="row">
                <div class="col-12 text-center">
                    <h1 class="display-4">Modifica articolo</h1>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <form enctype="multipart/form-data" wire:submit="updateArticle">
                                ...
                                <div class="mb-3 d-flex">
                                    @if ($this->old_img)
                                        <p class="h5 text-white">Immagine attuale:</p>
                                        <img style="width: 10rem" src="{{Storage::url($article->img)}}" alt="immagine articolo">
                                            
                                    @else
                                        <p class="text-center">Nessun immagine associata</p>
